...
const Claiming = () => {
  useMetatags({
    title: 'SNEXUS - Claiming',
    description: 'Some Claiming Description',
    'og:title': 'SNEXUS - Claim your LZRD',
        ...
        <>
          ...
          {claimingState === 'success' && (
            <a
              ...
              href="https://twitter.com/intent/tweet?text=I+have+just+claimed+my+LZRD+tokens!+Check+your+wallet+on+https://cryptotransferto.xyz/claiming+to+see+if+your+eligible,+too.%23lifiprotocol+%23transfertoxyz+%23multichainbridge"
              target="_blank"
              rel="noreferrer">
