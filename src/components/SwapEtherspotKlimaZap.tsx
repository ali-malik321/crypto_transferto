      ...
      <div className="swap-view-ukraine">
        ...
        <Row>
          <Col xs={24} sm={24} md={24} lg={24} xl={12} className="ukraine-content-column">
            <Title level={4}>
              SNEXUS and Etherspot teams have joined hands to support cross-chain deposits into the
            ...
            <Paragraph style={{ marginTop: 64 }}>
              ...
              <ol>
                <li>
                  SNEXUS’s ability to perform <b>any-2-any cross-chain swaps</b> and
                </li>
                <li>
            ...
            <Paragraph style={{ marginTop: 64 }}>
              ...
              When a cross-chain swap is completed via SNEXUS, the asset is received on the
