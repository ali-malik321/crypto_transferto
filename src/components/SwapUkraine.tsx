        ...
        <Row>
          <Col xs={24} sm={24} md={24} lg={24} xl={12} className="ukraine-content-column">
            ...
            <Paragraph style={{ marginTop: 64 }}>
              ...
              amounts. So, we’ve spun up a simple system using SNEXUS protocol to donate from any EVM
              chain, it will be stored in a Hardware Wallet controlled by SNEXUS team and will be
