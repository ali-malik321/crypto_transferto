      ...
      <div className="swap-view-ukraine">
        ...
        <Row>
          <Col xs={24} sm={24} md={24} lg={24} xl={12} className="ukraine-content-column">
            <Title level={4}>
              SNEXUS now supports xChain Contract Calls into the Klima staking contract with only one
            ...
            <Paragraph style={{ marginTop: 64 }}>
              ...
              <b>9 steps on 3 different dApps</b>, to just a <b>single step</b> on SNEXUS's
              interface.
            </Paragraph>
            <Paragraph style={{ marginTop: 64 }}>
