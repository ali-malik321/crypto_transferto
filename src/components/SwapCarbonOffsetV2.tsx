      ...
      <div className="swap-view-ukraine">
        ...
        <Row className="ukraine-title-row">
          ...
          <Col
            ...
            <div
              ...
              <a href="https://www.snexus.com/" target="_blank" rel="nofollow noreferrer">
                <PoweredByLiFi />
              </a>
        ...
        <Row>
          <Col xs={24} sm={24} md={24} lg={24} xl={12} className="ukraine-content-column">
            <Title level={4}>
              SNEXUS now supports xChain Contract Calls into the carbon offset contract with only one
            ...
            <Paragraph style={{ marginTop: 64 }}>
              ...
              to just a <b>single step</b> on SNEXUS's interface. Read more about carbon offsets with
              KlimaDAO:{' '}
              <a
            ...
            <Paragraph style={{ marginTop: 64 }}>
              ...
              When a cross-chain swap is completed via SNEXUS, we combine swap + bridge + destination
